...
class GetFriendListsResponse :
 ...
 public:
  ...
  // repeated .fixbug.User frined_list = 2;
  int frined_list_size() const;
  private:
  int _internal_frined_list_size() const;
  public:
  void clear_frined_list();
  ::fixbug::User* mutable_frined_list(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
      mutable_frined_list();
  private:
  const ::fixbug::User& _internal_frined_list(int index) const;
  ::fixbug::User* _internal_add_frined_list();
  public:
  const ::fixbug::User& frined_list(int index) const;
  ::fixbug::User* add_frined_list();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User > frined_list_;
  ::fixbug::Resultcode* result_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_test_2eproto;
};
...
// repeated .fixbug.User frined_list = 2;
inline int GetFriendListsResponse::_internal_frined_list_size() const {
  return frined_list_.size();
}
inline int GetFriendListsResponse::frined_list_size() const {
  return _internal_frined_list_size();
}
inline void GetFriendListsResponse::clear_frined_list() {
  frined_list_.Clear();
}
inline ::fixbug::User* GetFriendListsResponse::mutable_frined_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.frined_list)
  return frined_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListsResponse::mutable_frined_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResponse.frined_list)
  return &frined_list_;
}
inline const ::fixbug::User& GetFriendListsResponse::_internal_frined_list(int index) const {
  return frined_list_.Get(index);
}
inline const ::fixbug::User& GetFriendListsResponse::frined_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.frined_list)
  return _internal_frined_list(index);
}
inline ::fixbug::User* GetFriendListsResponse::_internal_add_frined_list() {
  return frined_list_.Add();
}
inline ::fixbug::User* GetFriendListsResponse::add_frined_list() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponse.frined_list)
  return _internal_add_frined_list();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListsResponse::frined_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResponse.frined_list)
  return frined_list_;
}
